...
// PROMPT: Add computer player which moves the paddle automatically.
...
function updateComputerPaddle() {
    computerPaddle.dy = (ball.y - (computerPaddle.y + computerPaddle.height / 2)) * 0.1;
...
function animateWithScoreAndComputer() {
    ctx.clearRect(0, 0, canvas.width, canvas.height);
    drawPaddle();
    drawComputerPaddle();
    drawBall();
    ...
    drawScore();
    requestAnimationFrame(animateWithScoreAndComputer);
}

animateWithScoreAndComputer();